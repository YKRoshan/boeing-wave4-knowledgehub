...
@EnableKafka
@Configuration
public class WebKafkaConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, WebAnalyticsKnowledge> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    //Kafka listener
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, WebAnalyticsKnowledge> userKafkaListenerFactory() {
