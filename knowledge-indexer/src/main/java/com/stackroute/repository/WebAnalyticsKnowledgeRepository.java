...
public interface WebAnalyticsKnowledgeRepository extends Neo4jRepository<WebAnalyticsKnowledge,String> {
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:knowledgeOf {confidenceScore:{3}}]->(k)")
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:comprehensionOf {confidenceScore:{3}}]->(k)")
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:applicationOf {confidenceScore:{3}}]->(k)")
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:analysisOf {confidenceScore:{3}}]->(k)")
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:synthesisOf {confidenceScore:{3}}]->(k)")
    ...
    @Query("match(p:Concept{name:{0}}) match(k:WebAnalyticsKnowledge{paragraphId:{1},intentLevel:{2}}) CREATE(p)-[:evaluationOf {confidenceScore:{3}}]->(k)")
